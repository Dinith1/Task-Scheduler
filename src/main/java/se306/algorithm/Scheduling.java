...
public class Scheduling {
     ...
     * 
     * @param numberOfProcessors - user defined number of processors that are
     *                           available to be used
     * @param listOfSortedNodes  - the list of nodes that are in sorted order from
     *                           InputReader class
     */
    public void createSchedule(int numberOfProcessors, List<Node> listOfSortedNodes) {
         ...
         * time and if equal then sorts by process identifier number
         */
