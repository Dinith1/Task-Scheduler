...
public class InputFileReader {
    public static int NUM_NODES = 4; // Testing with Nodes_7 (change later to read number of nodes from GraphViz
                                     // graph generator)
    public static int NUM_EDGES = 3; // Testing with Nodes_7 (change later to read number of edges from GraphViz
                                     // graph generator)
