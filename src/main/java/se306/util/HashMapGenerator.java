...
public class HashMapGenerator {
    ...
    /**
     * Adds the parents of a specified node and adds the array of parents to a
     * hashmap, using the parents as key, children as the value.
     * 
     ...
     */
    public static void addNodeToParentMap(int node, HashMap<int[], int[]> parentsMap,
            HashMap<Integer, int[]> nodeParents) {
    ...
    /**
     * Adds the children of a specified node and adds the array of children to a
     * hashmap, using the children as key, parents as the value.
     * 
     ...
     */
    public static void addNodeToChildrenMap(int node, HashMap<int[], int[]> childrenMap,
            HashMap<Integer, int[]> nodeChildren) {
    ...
    /**
     * Adds the edge weights of a specified node and adds the array of edges to a
     * hashmap, using the array of edges as key, nodes with the same set of edge
     * weights as the value.
     * 
     ...
     * @param listOfEdges    {{from, to, weight}, {f, t, w}, ...} Each from/to is
     *                       the id of the node
     */
     ...
     * 
     * @param listOfEdges {{from, to, weight}, {f, t, w}, ...} Each from/to is the
     *                    id of the node
